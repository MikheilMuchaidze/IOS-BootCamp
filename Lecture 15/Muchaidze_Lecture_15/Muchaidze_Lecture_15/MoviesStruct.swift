...
let moviesList = [
    ...
    Movie(title: "The Avengers", releaseDate: "2012", imdb: 8.9, mainActor: "Robert Downey Jr.", seen: false, isFavourite: true, description: "About group of superheroes which are united and fighting agains all kind of enemies which appear on earth"),
    ...
    Movie(title: "Game of Thrones", releaseDate: "2011", imdb: 9.8, mainActor: "Peter Dinklage", seen: false, isFavourite: true, description: "About people who are fighting for power and influance over country"),
...
public var moviesSeen = moviesList.filter { !$0.seen }
public var moviesNotSeen = moviesList.filter { $0.seen }
